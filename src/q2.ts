...
const WASM_B64 =
  ...
  'AX8AQQALBzAEA21lbQIAC3EyX3F1YW50aXNlAAIGcTJfa2V5AAMPcTJfbGVlX2Rpc3RhbmNlAAQKiQwF' +
  ...
  'BSADQQR2IQMLIANBCGuyDwsgACABQQJ2ai0AACEDIANBAyABQQNxa0EBdHZBA3GzC7cHBQR/BH0Efwt7' +
  ...
  'IREgESAV/UT9TSEXIBEgFv1E/U0hGCARIBT9RP1NIRlBAv0RQQP9ESAZ/VIhGkEB/REgGiAY/VIhGkEA' +
  '/REgGiAX/VIhGiAaIBpBAf2tAf1RIRsgG/0bAEEGdCAb/RsBQQR0ciAb/RsCQQJ0IBv9GwNyciEdIAQg' +
  'BkECdmogHToAACAGQQRqIQYMAAsLIAUPC0EAIQYCQANAIAYgAk8NASABQQFrIAJsIAZqIQcjACAGQQJ0' +
  'aiEIIAggACAHIAMQATgCACAGQQFqIQYMAAsLQwAAAAAhCkEAIQYCQANAIAYgAk8NASMAIAZBAnRqKgIA' +
  'IQkgCiAJIAmUkiEKIAZBAWohBgwACwsgCkOVleYkXgRAQwAAgD8gCpGVIQtBACEGAkADQCAGIAJPDQEj' +
  'ACAGQQJ0aiEIIAggCCoCACALlDgCACAGQQFqIQYMAAsLC0MIrCw/IAKzkZUhDEEAIQYCQANAIAYgBU8N' +
  'ASAEIAZqQQA6AAAgBkEBaiEGDAALC0EAIQYCQANAIAYgAk8NASMAIAZBAnRqKgIAIQlBAyENIAkgDIxf' +
  'BEBBACENBSAJQwAAAABfBEBBASENBSAJIAxfBEBBAiENCwsLIA0gDUEBdnMhDiAGQQJ2IQ9BAyAGQQNx' +
  'a0EBdCEQIAQgD2ogBCAPai0AACAOIBB0cjoAACAGQQFqIQYMAAsLIAULlQEDBn8BfgF/Qf8BIQdCACEI' +
  'QQAhCUEAIQICQANAIAIgAU8NASACQQJ2IQNBAyACQQNxa0EBdCEEIAAgA2otAAAgBHZBA3EhBSAFQQJx' +
  'IAVBAXYgBUEBcXNyIQYgBiAHRwRAIAYhByAJQSBJBEAgCCAGrUE+IAlBAXRrrYaEIQggCUEBaiEJCwsg' +
  'AkEBaiECDAALCyAIC9EBAgN/BXsgAkECdiEDQQAhBUEAIQQCQANAIARBEGogA0sNASAAIARq/QAEACAB' +
  'IARq/QAEAP1RIQYgBv1iIQcgB/19IQggCP1/IQkgCSAJ/Q0ICQoLDA0ODwABAgMEBQYHIQogCSAK/a4B' +
  'IQkgCSAJ/Q0EBQYHAAECAwgJCgsMDQ4PIQogCSAK/a4BIQkgBSAJ/RsAaiEFIARBEGohBAwACwsCQANA' +
  'IAQgA08NASAFIAAgBGotAAAgASAEai0AAHNpaiEFIARBAWohBAwACwsgBQs=';
 ...
 * Compute the Lee distance between two packed Gray-encoded Q² vectors.
 *
 * Pure-TypeScript reference implementation of the WASM q2_lee_distance
 * function. Exploits the Gray-map isometry (DESIGN.md §2.7 Theorem 2.1):
 *   d_H(φ(u), φ(v)) = d_L(u, v)
 *
